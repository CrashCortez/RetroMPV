...
wget -O control_updater_menu.sh https://raw.githubusercontent.com/CrashCortez/RetroMPV/master/control_updater_menu.sh
...
wget -O https://github.com/CrashCortez/RetroMPV/blob/master/controllertools.png
cd
